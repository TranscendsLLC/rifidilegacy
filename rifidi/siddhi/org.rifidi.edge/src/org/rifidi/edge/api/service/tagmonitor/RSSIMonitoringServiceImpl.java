...
public class RSSIMonitoringServiceImpl extends
   ...
   private static final String MAX_RSSI = "avgRSSI";
   ...
   public void subscribe(RSSIReadZoneSubscriber subscriber,
         HashMap<String,ReadZone> readZones, Float windowTime, TimeUnit timeUnit,
         Integer countThreshold, Double minAvgRSSIThreshold, Double changeRSSIThreshold, boolean useRegex) {
