...
public class Command_Update implements RemoteEdgeServerCommand {
	...
	// RemoteReaderFactory factory = (RemoteReaderFactory)
	// remoteEdgeServer.readerFactories
	...
	// }
	//
	// for (CommandConfigFactoryDTO commandFactory :
	// this.commandConfigFactoryDTO) {
	...
	// for (CommandConfigurationDTO commandConfig :
	// this.commandConfigurationDTOs) {
	...
	//
	// RemoteCommandConfigFactory factory = (RemoteCommandConfigFactory)
	// remoteEdgeServer.commandConfigFactories
