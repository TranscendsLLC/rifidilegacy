...
public class Command_PropertyChanged implements RemoteEdgeServerCommand {
	...
	// }
	// }
	// } else if (server.commandConfigurations.get(notification.getConfigID())
	// != null) {
	// RemoteCommandConfiguration config = (RemoteCommandConfiguration)
	// server.commandConfigurations
	// .get(notification.getConfigID());
	// if (config != null) {
	// for (Attribute a : notification.getAttributes().asList()) {
