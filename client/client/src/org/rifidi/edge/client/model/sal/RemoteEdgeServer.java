...
public class RemoteEdgeServer {
	...
	public RemoteEdgeServer() {
		...
		//FIXME: Find out what to do with these maps
	...
	//FIXME: Find another way to do these observablemaps
	...
	RS_ServerDescription getRSServerDescription() {
		// FIXME: TODO: Need to set the IP and port
		String ip = "";
		// SALModelPlugin.getDefault().getPreferenceStore().getString(
		// EdgeServerPreferences.EDGE_SERVER_IP);
		int port = 0;
		// Integer.parseInt(SALModelPlugin.getDefault()
	...
	public void handleAuthenticationException(AuthenticationException ex) {
		...
		//TODO: FIXME: Find a way to handle this
