...
public class SubmitJobWizardPage extends WizardPage {
	...
	public void createControl(Composite parent) {
		System.out.println("Calling createcontrol");
		try {
	...
	private void fillTree(Tree tree) {
		System.out.println("Calling fillTree");
		...
		System.out.println("Done calling filltree");
	...
	private void validate() {
		System.out.println("Validating the submitjobwizardpage");
		setPageComplete(true);
		System.out.println("Done validating the submitjobwizardpage");
	}
	...
	protected RemoteCommandConfiguration getSelectedConfiguration() {
		System.out.println("Getting the selected configuration");
	...
	protected Long getInterval() {
		System.out.println("Getting the selected interval");
