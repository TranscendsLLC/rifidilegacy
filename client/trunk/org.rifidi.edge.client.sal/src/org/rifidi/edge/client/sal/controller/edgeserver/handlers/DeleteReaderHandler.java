...
/**
 * A handler to delete a reader. Should only be invoked when edge server is
 * connected and selection is a RemoteReader
 * 
 * @author Kyle Neumeier - kyle@pramari.com
 */
public class DeleteReaderHandler extends AbstractHandler implements IHandler2 {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		controller.deleteReader(((RemoteReader) obj).getID());
