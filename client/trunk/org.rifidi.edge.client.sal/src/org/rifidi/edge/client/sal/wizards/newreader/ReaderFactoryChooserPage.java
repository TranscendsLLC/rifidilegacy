...
public class ReaderFactoryChooserPage extends WizardPage {
	...
	private void update() {
		...
		System.out.println("Next page: " + this.getNextPage());
		System.out.println("Wizard data: " + this.wizardData);
		
		((EditConnectionInfoPage) this.getNextPage()).setWizardData(wizardData);
		setPageComplete(true);
		
		System.out.println("Next page data: " + this.getNextPage().getWizard());

		System.out.println("Can flip to next page: " + this.canFlipToNextPage());
		System.out.println("Is page complete: " + isPageComplete());
