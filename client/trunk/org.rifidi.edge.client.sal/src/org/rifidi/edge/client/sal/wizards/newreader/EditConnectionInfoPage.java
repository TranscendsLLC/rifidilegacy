...
public class EditConnectionInfoPage extends WizardPage implements
	...
	public void createControl(Composite parent) {
		System.out.println("trying to create control");
		System.out.flush();
		this.parent = parent;
		if (wizardData != null) {
			draw();
	...
	public void setWizardData(final NewReaderWizardData wizardData) {
		this.wizardData = wizardData;
		System.out.println("Setting the wizard data");
		if (parent != null) {
			draw();
		}
	}
	 ...
	 */
	private void draw() {
		System.out.println("Attempting to draw this page!  ");
